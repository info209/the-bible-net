...
export default function LibraryHeader({
  ...
  const { refCallback: searchInputRef, focus: focusInput } = useAutoFocus<HTMLInputElement>({
    active: isSearchOpen,
  });
        ...
        <div className="relative animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          {searchQuery && (
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 cursor-pointer"
