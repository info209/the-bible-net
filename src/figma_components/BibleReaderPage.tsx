                ...
                <div className="flex items-center justify-between px-4 py-3 hover:bg-gray-100/50 transition-colors">
                  ...
                  <button
                    ...
                    className={`relative w-11 h-6 rounded-full transition-colors ${
                      hideFootnotes ? 'bg-[var(--color-primary-teal)]' : 'bg-gray-300'
                    }`}
                  >
                    <div
              ...
              {audioControlExpanded ? (
                    ...
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-full w-[32px] h-[32px] flex items-center justify-center">
                      <AnimatePresence mode="wait">
                        {audioPlaying ? (
                          ...
                          >
                            <Pause className="size-4 text-[var(--color-primary-teal)]/85 fill-[var(--color-primary-teal)]/85" strokeWidth={0} />
                          </motion.div>
                        ) : (
                          <motion.div
                            key="play"
                            ...
                            transition={{ duration: 0.2 }}
                          >
                            <Play className="size-4 text-[var(--color-primary-teal)]/85 fill-[var(--color-primary-teal)]/85 translate-x-[0.5px]" strokeWidth={0} />
                          </motion.div>
                        )}
                      </AnimatePresence>
                    </div>
                ...
                <motion.button
                  ...
                  onClick={() => {
                    ...
                    }, 500); // Give time for animations to complete
                  }}
